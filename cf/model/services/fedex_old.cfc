...
--->
	<cffunction name="getRates" access="public" returntype="struct" output="true">
        ...
        <cfargument name="myKey" type="string" required="no" default="JS8oEZ8UcQyD9z6j">
        <cfargument name="myPassword" type="string" required="no" default="syflxLjsgnIuuZ3O6eI4F7TVu">
        <cfargument name="myAccountNo" type="string" required="no" default="510087186">
        <cfargument name="myMeterNo" type="string" required="no" default="118580024">
        <cfargument name="sandbox" type="boolean" required="no" default="true">
    	<!---Shipper (Sender) Details--->
    	<cfargument name="shipperAddress1" type="string" required="no" default="#application.shipperAddress#">
        <cfargument name="shipperAddress2" type="string" required="no" default="">
        <cfargument name="shipperCity" type="string" required="no" default="#application.shipperCity#">
        <cfargument name="shipperState" type="string" required="no" default="#application.shipperState#">
        ...
        <cfargument name="shipToAddress1" type="string" required="no" default="57 Grove St">
        <cfargument name="shipToAddress2" type="string" required="no" default="">
        <cfargument name="shipToCity" type="string" required="no" default="North Attleboro MA">
        <cfargument name="shipToState" type="string" required="no" default="MA">
        <cfargument name="shipToZip" type="string" required="no" default="02760">
